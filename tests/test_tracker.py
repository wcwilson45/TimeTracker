...
class App:
    def __init__(self, root):
        ...
        # Page Title Label
        self.page_title = ttk.Label(self.menu_frame, text="NAVSEA Time Tracker", font=self.fonts['Body_Tuple'],
                                    background="#5DADE2")
        ...
        self.popup_menu.add_command(label="NAVSEA Time Tracker",
                                    command=lambda: self.switch_page("NAVSEA Time Tracker"))
    ...
    def setup_smalloverlay_page(self):
        ...
        self.small_overlay_start_button = tk.Button(self.smalloverlay_page, text="Start", relief="flat",
                                                    background="#77DD77", command=self.start_timer)
        self.small_overlay_start_button.grid(row=2, column=0, sticky=W, padx=0, pady=5)

        self.small_overlay_stop_button = tk.Button(self.smalloverlay_page, text="Stop", relief="flat",
                                                   background="#FF7276", command=self.stop_timer)
    ...
    def setup_full_page(self, task_list):
        ...
        for record in data:
            if count % 2 == 0:
                self.task_list.insert(parent='', index='end', iid=count, text='',
