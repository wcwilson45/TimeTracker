...
class AddTaskWindow(tk.Tk):  # Inherit from tk.Tk to make it a standalone app
    def __init__(self):
        super().__init__()
        ...
        # Time of Completion
        Label(self, text="Time of Completion (0:00am/pm month-day-year):").grid(row=3, column=0, sticky="w", padx=20, pady=10)
