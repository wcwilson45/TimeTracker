...
class EditTaskWindow(tk.Tk):
    ...
    def confirm_action(self):
        ...
        # Get old values before comparssion and update
        ...
        # Create a dictonary for comparing if anything actually changed
        old_values_dict = {
        'task_name': old_values[0],
        'task_time': old_values[1],
        'task_weight': old_values[2],
        'task_start_date': old_values[3],
        'task_end_date': old_values[4],
        'task_description': old_values[5],
        'task_weight_type': old_values[6],
        'task_tags': old_values[7]
        }
        ...
        if(old_values_dict == new_values):
            messagebox.showwarning("Warning", "No edits have been made.\nCannot confirm action.")
            self.lift()
            self.focus_force()
