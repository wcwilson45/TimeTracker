...
class App:
    ...
    def setup_full_page(self):
        ...
        add_task_button = tk.Button(self.full_page, text="Add Task", background="#d3d3d3",
    ...
    def setup_smalloverlay_page(self):
        ...
        Label(self.smalloverlay_page, text="Task Name:", font=self.Title_tuple, background="#add8e6").grid(row=0,
                                                                                                           column=0,
                                                                                                           sticky=W,
                                                                                                           pady=2)
